...
// Fix: Use React.FC to correctly handle standard props like 'key' in list renderings
const InsightCard: React.FC<{ insight: Notification, setView: (view: ViewState) => void }> = ({ insight, setView }) => {
    const { t } = useLanguage();
