...
const NAV_LINKS: NavLink[] = [
    ...
    { page: 'expenses', labelKey: 'expenses', icon: 'fas fa-wallet' },
    ...
    { page: 'manufacturing-analysis', labelKey: 'manufacturing-analysis', icon: 'fas fa-cogs' },
    { page: 'mutabakat', labelKey: 'reconciliation', icon: 'fas fa-handshake', roles: ['admin', 'muhasebe'] },
    // Updated: Pointing to the new 'email' hub instead of just drafts
    { page: 'email', labelKey: 'emailHub', icon: 'fas fa-envelope' },
    { page: 'yapay-zeka', labelKey: 'aiHubTitle', icon: 'fas fa-robot' },
    { page: 'raporlar', labelKey: 'reports', icon: 'fas fa-chart-line', roles: ['admin', 'muhasebe'] },
        ...
        <>
            ...
            <nav className={`fixed top-0 left-0 z-50 flex h-full w-64 flex-col bg-cnk-sidebar-dark text-cnk-sidebar-txt-dark transition-transform duration-300 md:relative md:transform-none ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className="flex items-center justify-between p-5">
                    ...
                    <button onClick={() => setIsOpen(false)} className="md:hidden text-2xl text-cnk-sidebar-txt-muted-dark hover:text-white">
                ...
                <div className="mt-auto border-t border-slate-700 p-4 space-y-3">
                    ...
                    <a href="#" onClick={(e) => {e.preventDefault(); logout();}} className="flex items-center gap-4 rounded-md px-4 py-3 text-sm font-medium transition-colors text-cnk-sidebar-txt-muted-dark hover:bg-red-500/20 hover:text-white">
