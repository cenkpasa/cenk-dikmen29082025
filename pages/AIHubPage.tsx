...
// Fix: Using React.FC to correctly handle standard props like 'key' in parent mappings
const AICard: React.FC<AICardProps> = ({ title, description, icon, placeholder, buttonText, onAction, isTextArea = false }) => {
